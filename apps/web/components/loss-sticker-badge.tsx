...
export function LossStickerBadge({
  ...
  return (
    <span
      className={cn(
        "inline-flex max-w-full shrink-0 items-center gap-0.5 overflow-hidden rounded-full border align-middle opacity-90 transition group-hover:opacity-100",
        ...
        size === "md" ? "px-1.5 py-0.5" : "px-1 py-0.5"
      )}
      aria-label={title}
      title={title}
    >
